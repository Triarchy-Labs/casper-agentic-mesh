	...
	return (
		<>
			...
			<section ref={heroRef} style={{ height: "100vh", position: "relative", overflow: "hidden" }}>
				...
				<div className="hero-phrases absolute top-0 inset-x-0 pt-[15vh] px-[5.5vw] max-lg:px-[4.10vw] max-sm:px-[5.97vw] z-[40] pointer-events-none mix-blend-difference will-change-transform" style={{ transform: "translateY(54vh)" }}>
					<div className="flex items-end justify-between gap-[6vw] max-lg:flex-col max-lg:items-start max-lg:gap-[3.07vh]">
						<h2 className="flex flex-wrap gap-x-[0.26em] gap-y-0 max-w-[42vw] max-lg:max-w-[62vw] uppercase tracking-tight text-white leading-[1.1]" style={{ fontFamily: "var(--font-tech), 'Sora', sans-serif", fontWeight: 300, fontSize: "clamp(28px, 3.95vw, 82px)" }}>
						...
						<div className="flex flex-col items-start gap-5 shrink-0 max-w-[34vw] max-lg:max-w-[45vw] max-sm:max-w-none">
							<p className="text-[var(--gray-800)]" style={{ fontFamily: "ui-monospace, 'Geist Mono', monospace", fontSize: "clamp(12px, 0.86vw, 18px)", lineHeight: 1.85, letterSpacing: "0.01em" }}><span className="block overflow-hidden"><span className="hero-line block whitespace-nowrap">But value can’t flow to a machine</span></span><span className="block overflow-hidden"><span className="hero-line block whitespace-nowrap">you can’t hold accountable. Triarchy</span></span><span className="block overflow-hidden"><span className="hero-line block whitespace-nowrap">is the command deck for that economy —</span></span><span className="block overflow-hidden"><span className="hero-line block whitespace-nowrap">escrow, a real-world oracle, and an</span></span><span className="block overflow-hidden"><span className="hero-line block whitespace-nowrap">adversarial tribunal, under one overseer.</span></span></p>
							<p className="text-white uppercase" style={{ fontFamily: "ui-monospace, 'Geist Mono', monospace", fontSize: "clamp(11px, 0.78vw, 16px)", letterSpacing: "0.14em" }}><span className="block overflow-hidden"><span className="hero-line block whitespace-nowrap">Every settlement live on Casper. <span className="text-[var(--red-700)]">Not a simulation.</span></span></span></p>
