            ...
            <div ref={sectionsRef} className="w-full px-[5.5vw] py-[120px] flex flex-col gap-12">
              ...
              <div className="flex flex-col gap-[13.67vh] max-sm:gap-[6vh] pt-[11.7vh] max-sm:pt-[4vh]">
                ...
                <div className="focus-cards grid grid-cols-12 gap-[1.39vw] max-sm:grid-cols-1 max-sm:gap-[3.48vh]">
                  ...
                  <div className="synergy-section editorial-panel p-[2.22vw] relative col-span-12 md:col-span-7 min-h-[48.8vh]">
                    <CornerMarks />
                  ...
                  <div className="synergy-section editorial-panel p-[2.22vw] relative col-span-12 md:col-span-4 md:col-end-13 md:mt-auto md:h-fit">
                    <CornerMarks />
                ...
                <div className="grid grid-cols-12">
                  <div className="synergy-section editorial-panel p-[3.5vw] md:p-[4.5vw] relative overflow-hidden border-[var(--red-900)] col-span-12 md:col-span-10 md:col-start-2 text-center min-h-[48.8vh] flex flex-col justify-center">
                    <CornerMarks />
                ...
                <div className="focus-cards grid grid-cols-12 gap-[1.39vw] max-sm:grid-cols-1 max-sm:gap-[3.48vh]">
                  ...
                  <div className="synergy-section editorial-panel p-[2.22vw] relative col-span-12 md:col-span-4 md:h-fit">
                    <CornerMarks />
                  ...
                  <div className="synergy-section editorial-panel p-[2.22vw] relative col-span-12 md:col-span-7 md:col-end-13 min-h-[48.8vh]">
                    <CornerMarks />
