					...
					<div className="col-span-12 md:col-span-4 sticky-section" style={{ height: 'auto', alignSelf: 'start', top: '120px' }}>
						<div className="editorial-panel p-[24px] w-full relative">
							...
							<textarea 
								...
								className="w-full min-h-[120px] bg-[var(--background-100)] border border-[var(--gray-500)] rounded-none p-[16px] text-[var(--gray-1000)] label-14-mono resize-none outline-none focus:border-[var(--blue-700)] mb-[16px] transition-colors z-10"
							/>
