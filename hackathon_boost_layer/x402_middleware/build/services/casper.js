 ...
 */
export function canonicalizeAccountHash(identifier) {
...
export async function verifyTransactionOnChain(txHash, options) {
    try {
        ...
        let amountMotes = null;
        let targetAccountHash = null;
        let paymentId;
